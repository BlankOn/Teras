...
Untuk mendapatkan berkas iso BlankOn, Anda bisa mengunduhnya dari situs resmi BlankOn [http://cdimage.blankonlinux.or.id/](http://cdimage.blankonlinux.or.id/). Berkas cetakan tersebut selanjutnya dapat dibuat _bootable_ ke Flashdisk atau Harddisk External dengan Unetbootin, cara lainya adalah dengan dibakar ke DVD kosong menggunakan aplikasi pembakar DVD seperti Brasero, K3b, Nero, Roxio, dsb.
...
![](/docs/CuplikanLayar/Pasang/3PilihBahasa.png)
...
![](/docs/CuplikanLayar/Pasang/5Pasang.png)
...
![](/docs/CuplikanLayar/Pasang04.png)
...
![](/docs/CuplikanLayar/Pasang05.png)

![](/docs/CuplikanLayar/Pasang06.png)
...
![](/docs/CuplikanLayar/Pasang07.png)
...
![](/docs/CuplikanLayar/Pasang08.png)
...
![](/docs/CuplikanLayar/Pasang/ModaMahir.png)
...
![](/docs/CuplikanLayar/Pasang09.png)

![](/docs/CuplikanLayar/Pasang10.png)
...
![](/docs/CuplikanLayar/Pasang11.png)

#### Proses Pemasangan

Ketika muncul tampilan proses Pemasangan BlankOn yang sedang berlangsung, tunggu beberapa saat hingga selesai.

![](/docs/CuplikanLayar/Pasang12.png)

![](/docs/CuplikanLayar/Pasang13.png)

![](/docs/CuplikanLayar/Pasang14.png)

![](/docs/CuplikanLayar/Pasang15.png)

![](/docs/CuplikanLayar/Pasang17.png)
...
![](/docs/CuplikanLayar/Pasang16.png)
...
![](/docs/CuplikanLayar/Pasang18.png)
