...
4.  **Lapisan, Kanal, Paths, Undo History ** merupakan fitur penting
...
5.  **Brushes/Poola/Gradasi: **ketika menggunakan GIMP standar fitur ini
...
**\*Preferensi** _=>_ **Antarmuka** _=>_ **Antarmuka Pengguna =>
